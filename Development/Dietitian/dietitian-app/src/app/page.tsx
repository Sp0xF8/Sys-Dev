			...
			<div className="px-6 py-4">
				...
				<form className="w-full">
					...
					<div className="flex items-center justify-between  mt-4">
						<Link className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline m-auto w-1/2" type="button" href="operator/dashboard">
							Sign In
						</Link>
					</div>
