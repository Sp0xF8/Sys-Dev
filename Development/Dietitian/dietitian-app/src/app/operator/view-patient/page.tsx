...
export default function aPatients() {
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-center p-4 dark:bg-slate-800 ">

			<div className="rounded overflow-hidden shadow-2xl dark:shadow-s dark:shadow-gray-600 bg-slate-200 dark:bg-gray-500 w-11/12">
